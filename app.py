...
# mail = Mail(app)
# db = SQLAlchemy(app)
app.config['MAIL_SERVER'] = 'smtp.gmail.com'  # Change if using Outlook or another provider
...
def send_mail(subject, recipient, body):
    ...
    with mail.connect() as conn:  # Explicitly connect before sending
        conn.send(msg)
...
def doctor_register():
    if request.method == 'POST':
        ...
        flash('success', 'Thank you for registering! Please wait for verification and check your email.')

        return render_template('doctor-register.html', show_popup=True)  # ✅ Trigger pop-up

    return render_template('doctor-register.html', show_popup=False)


@app.route('/doctor-dashboard')
def doctor_dashboard():
    return render_template('doctor-dashboard.html')  # Ensure this template exists
...
def prescribe_medicine(appointment_id):
    ...
    available_medicines = [
"Amoxicillin: Dental Infection",
"Clindamycin: Dental Infection (Penicillin Allergy)",
"Azithromycin: Dental Infection",
"Metronidazole: Periodontal Infection",
"Cephalexin: Dental Abscess",
"Doxycycline: Periodontal Disease",
"Erythromycin: Dental Infection (Alternative)",
"Augmentin: Severe Dental Infection",
"Penicillin VK: First-line Antibiotic",
"Ibuprofen: Dental Pain/Inflammation",
"Acetaminophen: Mild Dental Pain",
"Aspirin: Pain/Inflammation",
"Naproxen: Dental Pain/Swelling",
"Ketorolac: Severe Dental Pain",
"Tramadol: Moderate to Severe Dental Pain",
"Hydrocodone/Acetaminophen: Post-Surgery Pain",
"Oxycodone/Acetaminophen: Severe Dental Pain",
"Lidocaine: Local Anesthetic",
"Articaine: Local Anesthetic",
"Mepivacaine: Local Anesthetic",
"Bupivacaine: Long-Acting Anesthetic",
"Benzocaine: Topical Anesthetic",
"Chlorhexidine: Oral Rinse (Gum Disease)",
"Fluoride: Cavity Prevention",
"Hydrocortisone: Oral Ulcers",
"Dexamethasone: Oral Inflammation",
"Triamcinolone: Oral Ulcers",
"Prednisolone: Severe Oral Inflammation",
"Nystatin: Oral Fungal Infection",
"Miconazole: Oral Thrush",
"Clotrimazole: Oral Fungal Infection",
"Acyclovir: Oral Herpes",
"Valacyclovir: Cold Sores",
"Famciclovir: Herpes Management",
"Carbamide Peroxide: Oral Wound Cleaning",
"Peridex: Gum Disease Treatment",
"Doxycycline Gel: Periodontitis Treatment",
"Minocycline Microspheres: Periodontal Disease"
  ]
    ...
    if request.method == 'POST':
        ...
        jansevak_header = Paragraph("<font color='green' size='24'><b>Jeevni: We Care for Your Health</b></font><hr/>", header_style)
	...
	#content.append(jansevak_header)
        ...
        doctor_details = (
            ...
            "<font size='12'>Thank you for choosing Jeevni! We wish you good health.</font>"
        )
